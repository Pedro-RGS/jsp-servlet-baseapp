...
<main class="w-100 m-auto form-container">
    <form action="/register/chef" method="post">
        ...
        <div class="form-floating">
            <input type="number" name="idade" class="form-control" id="floatingIdade" placeholder="Digite sua idade" />
            <label for="floatingIdade">Idade</label>
        </div>
        <div class="form-floating">
            <input  name="ativo" class="form-control" id="floatingAtivo" placeholder="Está ativo?" />
            <label for="floatingAtivo">Ativo</label>
        </div>
